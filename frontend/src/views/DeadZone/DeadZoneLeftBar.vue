<template>
    <div>
        <div class='calileft'>
            <h4 class="white--text mx-2 mt-n16">DeadZone 설정</h4>
<!--            <v-data-table-->
...
<!--                &lt;!&ndash;                <template v-slot:item.channel="{ item }">&ndash;&gt;-->
<!--                &lt;!&ndash;                    <span style="width: 20px;font-weight: bold">{{ item.channel }}</span>&ndash;&gt;-->
